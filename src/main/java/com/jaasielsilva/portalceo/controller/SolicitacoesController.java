...
public class SolicitacoesController {
    ...
    public String exibirFormularioNova(Model model, Principal principal) {
        ...
        // Inicializar colaborador para binding do formulário
    ...
    public String aprovarSolicitacao(@PathVariable Long id,
        ...
        try {
            ...
            solicitacaoAcessoService.aprovarSolicitacao(id, usuarioLogado, nivel, emailCorporativo, observacoesAprovador);
        ...
        try {
            if ("APROVADO".equals(decisao) || "APROVADO_PARCIAL".equals(decisao)) {
                ...
                if (nivelAprovado == null || emailCorporativo == null || emailCorporativo.trim().isEmpty()) {
                    redirectAttributes.addFlashAttribute("erro", "Nível de acesso e email corporativo são obrigatórios para aprovação");
