...
public class AdesaoColaboradorController {
    ...
    public ResponseEntity<Map<String, Object>> processarDadosPessoais(
        ...
        try {
            ...
            String sessionId = adesaoService.salvarDadosTemporarios(dadosAdesao);
            ...
            dadosPessoaisMap.put("dataAdmissao", dadosAdesao.getDataAdmissao() != null ? dadosAdesao.getDataAdmissao().toString() : null);
            ...
            workflowService.salvarProcesso(sessionId, dadosPessoaisMap);
            workflowService.atualizarEtapa(sessionId, "dados-pessoais");
            
            response.put("success", true);
            response.put("sessionId", sessionId);
            response.put("proximaEtapa", "documentos");
            
            logger.info("Dados pessoais processados com sucesso para CPF: {}", dadosAdesao.getCpf());
            
        } catch (Exception e) {
            logger.error("Erro ao processar dados pessoais: ", e);
            response.put("success", false);
